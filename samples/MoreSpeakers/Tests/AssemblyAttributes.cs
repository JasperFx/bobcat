...
// `samples/MoreSpeakers/MoreSpeakers/` from the host assembly name — a folder that does not
...
// `samples/MoreSpeakers/Tests/bin/<config>/net10.0/`, four levels up is
// `samples/MoreSpeakers/`, where the host's appsettings.json lives.
