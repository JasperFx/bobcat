...
// `samples/BookingMonolith/BookingMonolith/` from the host assembly name — a folder that does
...
// `samples/BookingMonolith/Tests/bin/<config>/net10.0/`, four levels up is
// `samples/BookingMonolith/`, where the host's appsettings.json lives.
