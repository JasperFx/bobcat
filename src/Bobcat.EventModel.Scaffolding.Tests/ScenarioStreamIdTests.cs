...
public class ScenarioStreamIdTests
{
    ...
    public void a_stream_id_column_is_typed_as_a_guid_not_as_the_literal_token()
    {
        ...
        // The event record moved to the chapter's Events.cs; the inference it is pinning did not.
        files["Appointments/Events.cs"].ShouldContain("public record HomeCheckAppointmentProposed(Guid OwnerId);");
    }
