...
/// <summary>
/// The viewer under test: Bobcat.Monitor's real <c>Program</c>, booted in-process over Alba's
...
public sealed class MonitorHost : IHostResource, IAlbaResource
{
    ...
    private Task<IAlbaHost> boot()
    {
        ...
        return global::Alba.AlbaHost.For<Program>(builder =>
        {
            ...
            // wrong for anything under src/ — it looked for <repo>/Bobcat.Monitor/. The viewer has
