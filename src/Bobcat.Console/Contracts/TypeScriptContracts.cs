...
public static class TypeScriptContracts
{
    ...
    public const string GenerateCommandLine = "dotnet run --project src/Bobcat.Console -- generate";

    private const string frontEndSourceRelativePath = "src/Bobcat.Console.FrontEnd/src";
    ...
    /// the repository root and returns <c>src/Bobcat.Console.FrontEnd/src</c>; null when this is
    ...
    private static string header() =>
         ...
         *
         * TypeScript mirrors of src/Bobcat.Console/Contracts/MonitorEvents.cs, emitted by
